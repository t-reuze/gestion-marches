...
export default function ReportingCharts({ rows }) {
  ...
  return (
    <div className="reporting-chart-grid">
      ...
      <div className="card">
        <div className="card-header"><span className="card-title">CA TTC par Fournisseur</span></div>
        <div className="card-body" style={{ height: Math.max(350, byFournisseur.length * 32 + 40) }}>
      ...
      {/* Courbe : CA par Année */}
      <div className="card">
        <div className="card-header"><span className="card-title">CA TTC par Année</span></div>
      ...
      {/* Donut : CA par Marché */}
      <div className="card">
        <div className="card-header"><span className="card-title">CA TTC par Marché</span></div>
        <div className="card-body" style={{ height: 350 }}>
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie
